...
- Preserve applied state. Map columns like applied, has_applied, application submitted,
  or application status into applied when they clearly mean true or false.
